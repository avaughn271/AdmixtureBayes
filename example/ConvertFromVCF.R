#We read in the vcf
vcf = readLines("sampleData.vcf") #REPLACE THIS WITH ACTUAL VCF
...
Populations = c("pop1", "pop2", "pop2", "pop3", "pop1", "pop4",
                "pop4", "pop1", "pop1", "pop3", "pop3", "pop3")
#REPLACE THIS WITH ACTUAL LIST OF POPULATIONS

#For example, the above line means that
#pop1 is individuals: tsk_0 tsk_4 tsk_7 tsk_8
#pop2 is individuals: tsk_1 tsk_2
#pop3 is individuals: tsk_3 tsk_9 tsk_10 tsk_11
#pop4 is individuals: tsk_5 tsk_6
...
write.table(rbind(UniquePops, Output), "adbayesinput.txt", 
