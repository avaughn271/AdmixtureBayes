...
def getcovariance(inputt, outputt, addfile, add_Corr):
...
getcovariance('TemporaryFiles/TREEMIXoutput.txt', "TemporaryFiles/TREECov.txt", 'TemporaryFiles/TREEMIXoutgroup.txt', False)
getcovariance('TemporaryFiles/ORIENToutput.txt', "TemporaryFiles/ORIENTCov.txt", 'TemporaryFiles/ORIENToutgroup.txt', False)
