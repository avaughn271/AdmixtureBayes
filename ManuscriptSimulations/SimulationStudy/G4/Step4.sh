NUMBEROFSIMS=5   #PLACE 7
###################################################run admixturebayes
for (( c=1; c<=NUMBEROFSIMS; c++ ))
do

startinggadbayes=$[c+10]  # change this to 10 and then 15
echo $startinggadbayes
python3 ~/desktop/AdmixtureBayes-main/admixturebayes/runMCMC.py --input_file TemporaryFiles/adbayesinput${startinggadbayes}.txt --outgroup pop7 --n 120000 --save_covariance  --MCMC_chains 20  #PLACE 8 and last

#50000 and deafult number of chains takes 7.6 hours, but there are problems with processing the output???

#120000 and 20 chains takes 10 hours
