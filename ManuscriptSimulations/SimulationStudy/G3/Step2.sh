...
treemix                                                              -i treemixinput.txt.gz -o TemporaryFiles/treeoutput${c}   -k 1000                  -root pop5 -m 1 -global 
...
Rscript TreeMixCheckOutput.R pop5 $NUMBEROFSIMS ### remember that the script itself has to be edited for the outgroup location
