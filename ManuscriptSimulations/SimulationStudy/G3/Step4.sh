NUMBEROFSIMS=10   #PLACE 7

###################################################run admixturebayes
for (( c=1; c<=NUMBEROFSIMS; c++ ))
do

startinggadbayes=$[c+5]  # change this to 10 and then 15
echo $startinggadbayes

python3 ~/desktop/AdmixtureBayes-main/admixturebayes/runMCMC.py --input_file TemporaryFiles/adbayesinput${startinggadbayes}.txt --outgroup pop5 --n 110000 --save_covariance  --MCMC_chains 10    #PLACE 8 and last
