...
python3 ~/desktop/AdmixtureBayes-main/admixturebayes/runMCMC.py --input_file TemporaryFiles/adbayesinput${c}.txt --outgroup pop6 --n 60000 --save_covariance    #PLACE 8 and last
