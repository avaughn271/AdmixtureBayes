...
for (j in 1:as.numeric(args)){
convertoutput(
 paste0("TemporaryFiles/treeoutput",toString(j) , ".edges" ),
 paste0("TemporaryFiles/treeoutput",toString(j) , ".vertices" ),
 paste0("TemporaryFiles/TREEMIXoutput",toString(j) , ".txt" ),
 paste0("TemporaryFiles/TREEMIXoutgroup",toString(j) , ".txt" ))
convertoutput(
 paste0("TemporaryFiles/orientoutput",toString(j) , ".edges" ),
 paste0("TemporaryFiles/orientoutput",toString(j) , ".vertices" ),
 paste0("TemporaryFiles/ORIENToutput",toString(j) , ".txt" ),
 paste0("TemporaryFiles/ORIENToutgroup",toString(j) , ".txt" ))
